...
class DatabaseSchemaTest < ActiveSupport::TestCase
  ...
  test "column_name_style" do
    ...
    assert_equal false, database_schema.column_name_style_normal?

    database_schema = DatabaseSchema.new(column_name_style: "normal")
    assert_equal true, database_schema.column_name_style_normal?
